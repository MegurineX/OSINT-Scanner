...
def main():
    ...
    while True:
        print("\n")
        print(f"{CYAN}          INFORMATION FOR USING THIS TOOLS!{RESET}")
        print("\n")
        print("   1. to search using username or email, depending on the sites.")
        print("   2. Add your own API in configs/api_keys.env.")
        print("   3. For phone number scan, use the country code. example (+81).")
        print("   4. This tool is still under development.")
        print("   5. report bugs/errors on github repo.")
        print("\n")
        print(YELLOW + "=" * 55)
